...
");
    ...
    internal class BurstAotCompiler : IPostBuildPlayerScriptDLLs
    {
        ...
        private readonly string BurstMiscPathPostFix = "_BurstDebugInformation_DoNotShip";
        private string FetchOutputPath(BuildReport report)
        {
        ...
        private void OnPostBuildPlayerScriptDLLsImpl(BuildReport report)
        {
            ...
            var burstMiscAlongsidePath = FetchOutputPath(report);
